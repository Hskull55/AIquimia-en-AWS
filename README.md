...
- [certbot](https://certbot.eff.org/)
    - [Nginx on Debian 10](https://certbot.eff.org/instructions?ws=nginx&os=debianbuster)
- [ChatGPT](https://chat.openai.com/)
- [CloudDevs](https://clouddevs.com/)
    - [How to set up HTTPS (SSL) for a Django website?](https://clouddevs.com/django/set-up-https-ssl/#:~:text=How%20to%20set%20up%20HTTPS%20%28SSL%29%20for%20a,Renew%20SSL%20Certificates%3A%20...%208%20Monitor%20Security%3A%20)
...
- [Let's Encrypt](https://letsencrypt.org/es/)
    - [Comenzando](https://letsencrypt.org/es/getting-started/)
