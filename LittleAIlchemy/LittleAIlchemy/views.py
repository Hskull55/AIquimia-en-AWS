...
def alquimia(request):
    ...
    if request.method == 'POST':
        ...
        # Ponemos el elemento 363 (Water) como predeterminado si se intentó combinar con uno o ambos elementos vacíos
        elementoId1 = elementoId1 if elementoId1 != '' else '363'
        elementoId2 = elementoId2 if elementoId2 != '' else '363'
